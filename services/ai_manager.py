...
class AIManager:
    ...
    async def generate_workout_pages(self, user_data: dict) -> list[str]:
        ...
        2. Формат заголовка для тренировки: 📅 <b>[Дата], День [Номер] ([День недели]) — ТРЕНИРОВКА</b>
        3. Формат заголовка для отдыха: 📅 <b>[Дата], День [Номер] ([День недели]) — ВОССТАНОВЛЕНИЕ</b>
        4. Между упражнениями ОБЯЗАТЕЛЬНО ПУСТАЯ СТРОКА.
        5. ЗАПРЕЩЕНО писать вступление, анализ ИМТ, расчеты калорий или принципы плана в самом начале.
        6. СРАЗУ начинай с программы тренировок по дням.
        7. Формат упражнения:
        <b>[Номер]. [Название]</b>
